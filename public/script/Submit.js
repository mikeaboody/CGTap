var submit = function() {
	...
	for (id in tr_map) {
		...
		if (currSubmitObj == null) {
			swal("Insufficient Time!", "One of your projects has a recorded time of only 5 minutes or less. A valid submission contains only projects with more than 5 minutes of time.", "error");
			return;
		}
