...
var createSubmitObj = function(tr) {
	...
	submitObj.project_nm = tr.$projectJQ().find("option:selected").text();
	submitObj.project_id = tr.$projectJQ().find("option:selected").val();
	submitObj.task_nm = tr.$taskJQ().find("option:selected").text();
	submitObj.task_id = tr.$taskJQ().find("option:selected").val();
	submitObj.task_type_nm = tr.$taskTypeJQ().find("option:selected").text();
